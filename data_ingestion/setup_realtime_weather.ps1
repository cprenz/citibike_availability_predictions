# Registers an hourly Task Scheduler job that fetches near-realtime weather
# into weather_realtime. Runs at :00 each hour, 5 minutes before scoring.
# Run once from an elevated (Administrator) PowerShell prompt.
#
# Usage:
#   Right-click PowerShell -> "Run as Administrator"
#   .\setup_realtime_weather.ps1

$TaskName   = "CitibikeWeatherRealtime"
$ProjectDir = "C:\Users\clark\Desktop\citibike"
$PythonExe  = "C:\Users\clark\AppData\Local\Programs\Python\Python39\pythonw.exe"
$ScriptFile = "$ProjectDir\data_ingestion\ingest_weather_realtime.py"
...
Write-Host ""
Write-Host "Task '$TaskName' registered. Runs hourly at :00."
Write-Host ""
